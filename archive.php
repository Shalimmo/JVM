    ...
    <div id="inner-content" class="content--inner wrap"  role="main">
        ...
        <section class="content--page">
            ...
            ?>
                    ...
                    <?php } else { ?>
                    <a href="<?php the_permalink(); ?>"><img width="125" height="125" src="<?php bloginfo('template_directory'); ?>/images/img-placeholder-itinerary.jpg" alt="<?php the_title(); ?>" title="<?php the_title(); ?>">
                    <?php } ?>
                    </div>
