...
<!-- End Google Tag Manager (noscript) -->
			<div id="container">
        	<div style="background-color:#fff;"><p style="padding-left:5px;font-style:italic;display: inline-block;vertical-align: middle;margin-left: 20px;margin-right:20px;margin-top:20px;"><span style="width:20px;height: 20px;vertical-align: middle;display: inline-block;margin-right: 5px;background: url('https://villas.journeymexico.com/wp/wp-content/themes/journeymexico/images/verified_user-24px.svg');"></span><strong>Reserva con Confianza</strong> - queremos que te sientas lo más seguro posible al planear tus próximas vacaciones.<a href="/book-with-confidence" style="color:#ef8a0b;"> Ver más &gt;&gt;</a></p></div>
        <a class="link-home" href="<?php bloginfo('home'); ?>"></a>
			...
			<header class="header" id="banner" role="banner">
               ...
               <div class="wrap">
						...
						<p id="header-contact">CONTÁCTANOS</p>&nbsp;&nbsp;&nbsp;&nbsp;<p id="header-phone">+1 646 688 5650</p></div>
