...
<head>
    ...
    <body <?php body_class();?> >
        ...
        <!-- End Google Tag Manager (noscript) -->
            <div id="container">
            <!--
            <div style="background-color:#fff;"><img src="/wp/wp-content/themes/journeymexico/images/verified_user-24px.svg" style="width:20px;vertical-align: middle;display: inline-block;margin-left:
            -->
                    ...
                    <div class="wrap">
                        <div id="sub-nav">
                            <div class="sub-nav-right">  
                                <a href="/my-favorite-villas" style="color: #fff;margin: 0 5px 0 5px;background: #505050;padding: 5px 10px;"><i class="sf-icon-love" style="font-size:16px; padding: 0 5px 0;"></i><span>My 
