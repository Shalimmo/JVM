...
if ( divPH ) {
	...
	var checkInDate = '10/27/2019';
	var checkOutDate = '10/28/2019';
	var ticketCost = 3250.00;
	var hotelCost = 4625.00;
	...
	function calculateinterested(){
		...
		if (this.value == 'Formula 1 Event & Accommodation') {
			if ( divPH.style.display == 'none' ) {
				...
				ph.value = '5 nights - In 23th, Out 28th';
				rn.value = '1'; 
			}
			if(tn.value == 'none'){
				tn.value = '1';
	...
	function calculateHotelPrice(){
		...
		if(ph.value == '5 nights - In 23th, Out 28th'){//comentar para quitar select
			hotelCost = 4625.00;
		} else if ( ph.value == '4 nights - In 24th, Out 28th' ) {//comentar para quitar select
			hotelCost = 3767.00;
		}else if ( ph.value == 'none' ) {//comentar para quitar select
			hotelCost = 0;
		} 
		else {
			hotelCost = 2910.00;
...
<style type="text/css">
select#roomsnumber option[value="0"] {display: none;}
</style>