<?php
/*
Template Name: Customize your trip
*/
get_header(); ?>
...
<div id="content" class="clean">
	...
	<div id="inner-content" class="content--inner addwrap"  role="main">
    <?php the_content(); ?>
			  
	</div> <!-- end #inner-content -->
</div> <!-- end #content -->
<div class="guides-exp">
	<div class="guides-exp-cont">
    	<h2>MEET SOME OF OUR EXPERTS & GUIDES:</h2>
    	<p>We only work with the best in the business</p>
    </div>
    <div class="guides-gal">
