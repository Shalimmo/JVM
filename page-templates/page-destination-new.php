...
<div class="header-image">
	<figure>
		...
		<figcaption>
			...
			<span>LUXURY VACATION RENTALS</span>
		</figcaption>
	</figure>
</div>
...
<div class="wrap" style="text-align:center;margin-top: 60px;margin-bottom:60px;"><h2 style="color:#333;">COMPARE YOUR FAVORITE VILLAS</h2><p style="font-size:16px;">Mark your favorite villas and go to your favorite villas page to compare them.</p><a href="/my-favorite-villas" style="text-decoration:none;color: #fff;margin: 0 5px 0 5px;background: #505050;padding: 5px 10px;"><i class="sf-icon-love" style="font-size:16px; padding: 0 5px 0;"></i><span>My Favorite villas</span></a></div>
...
<div class="plan" style="background:#f4f4f4 !important;">
