	...
	<div class="plan--content border">
		...
		<form id="form-trip" method="post" accept-charset="utf-8" action="#plan-your-trip" class="plan--form">
			...
			<fieldset class="planner--side-f">
				...
				<div class="plan--form--line planner--side-t">
					<span class="label">Travel dates<sup>*</sup>:</span>

					<div class="plan--form--travel planner--side-c">
			...
			<fieldset class="planner--side-g">
				...
				<div class="plan--form--line plan--line__columns planner--side--s">
					<label for="trip-adults">Adults<sup>*</sup>:</label>
					<select id="trip-adults" name="trip-adults">
					<option>2</option>
					<option>4</option>
					<option>6</option>
					<option>8</option>
				...
				<div class="plan--form--line plan--line__columns planner--side--s">
					<label for="trip-children_0">Children :</label>
					<select id="trip-children_0" name="trip-children_0">
					<option>none</option>
					<option>1</option>
					<option>2</option>
					<option>3</option>
				...
				<div class="plan--form--line plan--line__columns planner--side--s">
					<label for="trip-bedrooms">Bedrooms:</label>
					<select id="trip-bedrooms" name="trip-bedrooms">
					<option>2</option>
					<option>3</option>
					<option>4</option>
					<option>5</option>
			...
			<fieldset>
<div class="g-recaptcha" data-sitekey="6Lf0qRETAAAAALtKhw0rKd4Nm0Q8d-cHXE7eTJr5" style="transform:scale(0.88);-webkit-transform:scale(0.88);transform-origin:0 0;-webkit-transform-origin:0 0;"></div>
				<input type="submit" class="js-trip-submit siderl" value="Send" id="sidersubmit">
		...
		<table>
			<tr>
				<td><img src="http://demo.villas.journeymexico.com/wp/wp-content/uploads/2016/06/eagle.png"></td>
