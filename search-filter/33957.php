...
if ( $query->have_posts() )
{
	...
	<p style="text-align:center; margin-bottom:0;font-family:'lato';margin-top:12px;"><?php echo $query->found_posts; ?> Villa(s) Found in Punta Mita<p/>
	...
	while ($query->have_posts())
	{
		...
		<article class="villasArchive">
					...
					<figure role="group" aria-labelledby="caption" class="destinationsArchive--fig">
						...
						<?php if ( has_term( 'golf', 'Collections') and has_term( 'celebrity', 'Collections')) {?>	
							<a class="golfwrap" href="/golf"><span class="golfleft"><span class="tooltiptext">Golf collection</span></span></a>
							<a class="celebritywrap" href="/celebrity"><span class="celebrity"><span class="tooltiptext">Celebrity collection</span></span></a>
							<?php } elseif ( has_term( 'surf', 'Collections') and has_term( 'yoga-wellness', 'Collections')) {?>	
							<a class="surfwrap" href="/surf"><span class="surfleft"><span class="tooltiptext">Surf collection</span></span></a>
							<a class="yogawrap" href="/yoga-wellness"><span class="yoga"><span class="tooltiptext">Yoga & Wellness collection</span></span></a>
						<?php } elseif ( has_term( 'all-inclusive', 'Collections') and has_term( 'yoga-wellness', 'Collections')) {?>
							...
							<a class="yogawrap" href="/yoga-wellness"><span class="yoga"><span class="tooltiptext">Yoga & Wellness collection</span></span></a>
						<?php } elseif ( has_term( 'all-inclusive', 'Collections') and has_term( 'celebrity', 'Collections')) {?>
							<a class="allinclusivewrap" href="/all-inclusive"><span class="allinclusiveleft"><span class="tooltiptext">All inclusive collection</span></span></a>
							<a class="celebritywrap" href="/celebrity"><span class="celebrity"><span class="tooltiptext">Celebrity collection</span></span></a>
