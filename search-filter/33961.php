...
if ( $query->have_posts() )
{
	...
	<p style="text-align:center; margin-bottom:0;font-family:'lato';margin-top:12px;"><?php echo $query->found_posts; ?> Villa(s) Found in Riviera Maya<p/>
	...
	while ($query->have_posts())
	{
		...
		<article class="villasArchive">
					...
					<figure role="group" aria-labelledby="caption" class="destinationsArchive--fig">
						...
						<?php if ( has_term( 'all-inclusive', 'Collections') and  has_term( 'haciendas', 'Collections')) {?>
							<a class="allinclusivewrap" href="/all-inclusive"><span class="allinclusiveleft"><span class="tooltiptext">All inclusive collection</span></span></a>
							<a class="haciendaswrap" href="/haciendas"><span class="haciendas"><span class="tooltiptext">Haciendas collection</span></span></a>
							<?php } elseif ( has_term( 'all-inclusive', 'Collections') and has_term( 'haciendas', 'Collections') and has_term( 'tennis', 'Collections')){?>
							<a class="allinclusivewrap" href="/all-inclusive"><span class="allinclusiveleft-2"><span class="tooltiptext">All inclusive collection</span></span></a>
							<a class="haciendaswrap" href="/haciendas"><span class="haciendasleft"><span class="tooltiptext">Haciendas collection</span></span></a>
							<a class="tenniswrap" href="/tennis"><span class="tennis"><span class="tooltiptext">Tennis collection</span></span></a>
						<?php } elseif ( has_term( 'all-inclusive', 'Collections') && has_term( 'haciendas', 'Collections') && has_term( 'large-groups', 'Collections')){?>
							<a class="allinclusivewrap" href="/all-inclusive"><span class="allinclusiveleft-2"><span class="tooltiptext">All inclusive collection</span></span></a>
							<a class="haciendaswrap" href="/haciendas"><span class="haciendasleft"><span class="tooltiptext">Haciendas collection</span></span></a>
							<a class="tenniswrap" href="/large-groups"><span class="groups"><span class="tooltiptext">Large groups collection</span></span></a>
							...
							<a class="celebritywrap" href="/celebrity"><span class="celebrity"><span class="tooltiptext">Celebrity collection</span></span></a>
							<?php } elseif ( has_term( 'surf', 'Collections')) {?>	
							<a class="surfwrap" href="/surf"><span class="surf"><span class="tooltiptext">Surf collection</span></span></a>
