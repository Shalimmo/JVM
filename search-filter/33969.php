...
if ( $query->have_posts() )
{
	...
	<p style="text-align:center; margin-bottom:0;font-family:'lato';margin-top:12px;"><?php echo $query->found_posts; ?> Villa(s) Found in Puerto Vallarta<p/>
	...
	while ($query->have_posts())
	{
		...
		<article class="villasArchive">
					...
					<figure role="group" aria-labelledby="caption" class="destinationsArchive--fig">
						...
						<?php if ( has_term( 'all-inclusive', 'Collections') and  has_term( 'yoga-wellness', 'Collections')) {?>
							...
							<a class="yogawrap" href="/haciendas"><span class="yoga"><span class="tooltiptext">Yoga collection</span></span></a>
							<?php } elseif ( has_term( 'large-groups', 'Collections') and has_term( 'yoga-wellness', 'Collections') ){?>
							<a class="largegroupswrap" href="/large-groups"><span class="groupsleft"><span class="tooltiptext">Large groups collection</span></span></a>
