...
if ( $query->have_posts() )
{
	...
	<p style="text-align:center; margin-bottom:0;font-family:'lato';margin-top:12px;"><?php echo $query->found_posts; ?> Villa(s) Found<p/>
	...
	while ($query->have_posts())
	{
		...
		<article class="villasArchive">
					...
					<figure role="group" aria-labelledby="caption" class="destinationsArchive--fig">
						...
						<?php if ( has_term( 'surf', 'Collections') ) {?>	
							<a class="allinclusivewrap" href="/surf"><span class="surf"><span class="tooltiptext">Surf collection</span></span></a>
