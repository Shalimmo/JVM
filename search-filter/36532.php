...
if ( $query->have_posts() )
{
	...
	<div id="inner-content" class="wrap"  role="main">
		<h3 style="font-weight:600;color#333;font-size:24px;margin:26px 0 26px 0;text-align:center;">RIVIERA MAYA</h3>
		...
		if( $festive && in_array('thumbnail', $festive) ): ?>
			...
			<article class="villasArchive">
					...
					<div class="destinationsArchive--figcap">
							...
							<p class="rside" style="font-family:'lato';font-size:15px;"><p class="rside" style="font-family:'lato';font-size:16px;"><sup>From&nbsp;</sup><strong><?php if (get_field('festive_minimum_price')) {echo get_field('festive_minimum_price');} ?></strong></p>
							</div>
	...
	<section>
				<table class="othervillas">
					<tr><th colspan="5">OTHER VILLAS</th></tr>
					<tr><th>&nbsp;</th><th>&nbsp;</th><th>&nbsp;</th><th>Christmas</th><th>New Year</th></tr>
	<?php
	while ($query->have_posts())
	{
