...
if ( $query->have_posts() )
{
	...
	<p style="text-align:center; margin-bottom:0;font-family:'lato';margin-top:12px;"><?php echo $query->found_posts; ?> Villa(s) for Yoga & Wellness<p/>
	...
	while ($query->have_posts())
	{
		...
		<article class="villasArchive">
					...
					<figure role="group" aria-labelledby="caption" class="destinationsArchive--fig">
						...
						<?php if ( has_term( 'yoga-wellness', 'Collections' ) ) { ?>
							<a class="yogawrap" href="/yoga-wellness"><span class="yoga"></span></a>
							<?php } ?>
					</figure>
					</a>
