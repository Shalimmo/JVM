...
if ( $query->have_posts() )
{
	...
	<p style="text-align:center; margin-bottom:0;font-family:'lato';margin-top:12px;"><?php echo $query->found_posts; ?> Villa(s) for Golf<p/>
					...
					<figure role="group" aria-labelledby="caption" class="destinationsArchive--fig">
						...
						<picture>
							...
							<img srcset="<?php the_post_thumbnail_url('jmvillas-thumb');?>" alt="<?php the_title(); ?>">
									...
									<?php if ( has_term( 'golf', 'Collections' ) ) { ?>
							<a class="golfwrap" href="/golf"><span class="golf"></span></a>
							<?php } ?>
					</figure>
					</a>
