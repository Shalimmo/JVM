...
if ( $query->have_posts() )
{
	...
	<p style="text-align:center; margin-bottom:0;font-family:'lato';margin-top:12px;"><?php echo $query->found_posts; ?> Villa(s) for Haciendas<p/>
					...
					<figure role="group" aria-labelledby="caption" class="destinationsArchive--fig">
						...
						<picture>
							...
							<img srcset="<?php the_post_thumbnail_url('jmvillas-thumb');?>" alt="<?php the_title(); ?>">
									...
									<?php if ( has_term( 'haciendas', 'Collections' ) ) { ?>
							<a class="haciendaswrap"><span class="haciendas"></span></a>
							<?php } ?>
					</figure>
					</a>
