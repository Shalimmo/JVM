...
if ( $query->have_posts() )
{
	...
	<p style="text-align:center; margin-bottom:0;font-family:'lato';margin-top:12px;"><?php echo $query->found_posts; ?> Villa(s) for Surfing<p/>
		...
		<article class="villasArchive">
					...
					<figure role="group" aria-labelledby="caption" class="destinationsArchive--fig">
						...
						<picture>
							...
							<a class="surfwrap"><span class="surf"></span></a>
							<?php } ?>
					</figure>
					</a>
