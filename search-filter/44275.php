...
if ( $query->have_posts() )
{
	...
	<p style="text-align:center; margin-bottom:0;font-family:'lato';margin-top:12px;"><?php echo $query->found_posts; ?> Villa(s) Found in Baja<p/>
		...
		<article class="villasArchive">
					...
					<figure role="group" aria-labelledby="caption" class="destinationsArchive--fig">
						...
						<picture>
							...
							<?php if ( has_term( 'tennis', 'Collections') and  has_term( 'celebrity', 'Collections')) {?>	
							<a class="tenniswrap" href="/tennis"><span class="tennisleft"><span class="tooltiptext">Tennis collection</span></span></a>
							<a class="celebritywrap" href="/celebrity"><span class="celebrity"><span class="tooltiptext">Celebrity collection</span></span></a>
							<?php } elseif ( has_term( 'golf', 'Collections') and  has_term( 'celebrity', 'Collections')){?>
							<a class="golfwrap" href="/golf"><span class="golfleft"><span class="tooltiptext">Golf collection</span></span></a>
							<a class="celebritywrap" href="/celebrity"><span class="celebrity"><span class="tooltiptext">Celebrity collection</span></span></a>
						<?php } elseif ( has_term( 'golf', 'Collections') and  has_term( 'tennis', 'Collections')){?>
							<a class="golfwrap" href="/golf"><span class="golfleft"><span class="tooltiptext">Golf collection</span></span></a>
					...
					<div class="destinationsArchive--figcap">
							...
							<div>
							<p class="lside" style="font-family:'lato';font-size:15px;margin-bottom:0px;">
							...
							<p class="lside" style="font-family:'lato';font-size:15px;display:block;">
								<?php if (get_field('place')) {echo get_field('place');} ?>
							</p>
							</div>
